...
2. What does the name mean, and what does it imply about the bacteria in this group?
3. What is the `Taxonomic status` of this name?
4. Is this name the "correct name" for the organism?
:::
...
- Read the `Notes` section on the LPSN page for _Ochrobactrum_ (the genus).
