...
There is new material in this workshop that is not covered in lectures, and this material is examinable. Please be sure to read the text in the expandable callout boxes, as well as that for the workshop, to be sure you have understood the topic and obtain full value from the exercise.
...
- Obtain an identification for a genome sequenced bacterial isolate from its assembled genome sequence, using a range of techniques, _via_ public bioinformatics services
...
- Compare and make an informed judgement between alternative taxonomic assignments for bacteria made using different computational approaches and databases.
