...
- Percent coverage: what proportion (percentage) of the _query_ is similar enough to the match to which it has been aligned
...
To do this, hover over a line dividing two columns, left-click and hold to grab it, then move the mouse left or right to resize the column.
:::
...
::: { .callout-important title="Questions"}
1. What is the taxonomic identity of the [last common ancestor (LCA)](https://evolution.berkeley.edu/glossary/most-recent-common-ancestor/) that SILVA assigns to your isolate (`lca_tax_slv` or `LCA tax. SILVA` column - this is the right-most column of data in the file)?
2. How similar (`Identity` column) does SILVA say your isolate is to that last common ancestor (LCA) sequence?
:::
...
4. What is your current opinion about the identity of your isolate? Have you revised it since the BLAST search? How confident are you in your identification?
:::
