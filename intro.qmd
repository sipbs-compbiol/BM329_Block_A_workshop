...
At the lab they've managed to sequence the bacterium that's in your blood, using an [Oxford Nanopore MinION](https://store.nanoporetech.com/uk/minion.html) they had lying around. The assembled draft genome has come back, but the [NHS is chronically underfunded and the staff are massively overworked](https://www.channel4.com/news/inside-nhs-hospital-at-96-capacity-as-new-report-warns-of-overcrowding-amid-flu-admissions-rise), so your consultant hasn't had time to learn how to classify bacteria from genome sequence data.
